...
print("Here")
mints000Pre  = Image.open("mints50.bmp")
mints001Pre  = Image.open("mints02.bmp")
mints002Pre  = Image.open("mints05.bmp")
mints003Pre  = Image.open("mints04.bmp")
mints004Pre  = Image.open("mints03.bmp")

mints000  = mints000Pre.rotate(180)
mints001  = mints001Pre.rotate(180)
mints002  = mints002Pre.rotate(180)
mints003  = mints003Pre.rotate(180)
mints004  = mints004Pre.rotate(180)


mints000.save("mints000.bmp")
mints001.save("mints001.bmp")
mints002.save("mints002.bmp")
mints003.save("mints003.bmp")
mints004.save("mints004.bmp")
#
# #
# #
# # def showIntro():
